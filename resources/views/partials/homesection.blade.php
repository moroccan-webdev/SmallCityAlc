            ...
            <div class="main_home text-center">
                <div class="col-md-12">
                    <div class="hello_slid">
                        <div class="slid_item">
                            <div class="home_text ">
                                <h2 class="text-white">Welcome to <strong>SmallCity</strong></h2>
                                <h1 class="text-white">We Do Entertainement All The Time</h1>
                                <h3 class="text-white">- We Teach without <strong>Pens and Boards</strong> into The Market -</h3>
                            </div>
