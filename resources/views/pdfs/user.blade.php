      ...
      <main>
        <div id="details" class="clearfix">
          ...
          <div id="invoice">
            ...
            <div class="date">Created At {{$user->created_at}}</div>
          </div>
        </div>
        <table border="0" cellspacing="0" cellpadding="0">
          ...
          <tbody>
            <tr>
              ...
              <td class="desc"><h3>{{$user->name}}</h3>{{$user->email}}</td>
              <td class="unit">{{$user->class}}</td>
              <td class="qty">{{$user->role->role}}</td>
              <td class="unit">{{$user->level_id}}</td>
            </tr>
          </tbody>
        </table>
